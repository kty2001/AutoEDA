...
> **상태: 배포됨 — <https://autoeda.tyoujungzz.workers.dev>.** CSV 읽기부터 통계·품질 점수·발견 목록·차트·전처리·타깃 분석·차원축소·결과 공유까지 구현되어 있고 테스트 386건이 통과함.
...
```bash
npm test            # 전체 테스트 386건 (계약·동작·통합·빌드·산출물 폐합)
