...
| `/pages/glossary` | 용어집 — 용어 40여 항목 | 빌드 | ○ | ○ | ○ |
...
| **C** 결과 | 7섹션 **탭 전환** | 개요 / 품질 / 발견 / 변수별 / 관계 / 전처리 / 타깃 + `결과 내보내기`·`결과 지우기`·`새 파일` |
...
**각 탭의 표시 개수 상한은 [`rules.md §4`](./rules.md)가 단일 원천임** — 발견 목록 기본 15건, 변수별 초기 차트 8열, 산점도 6쌍, 히트맵 20열, 다중 컬럼 관계 후보 3건, 범주형 연관성 히트맵 20열. 수치를 여기 옮겨 적지 않고 참조함.
