...
> **같은 인프라의 실측 근거**: 형제 프로젝트 `anime-semantle`이 동일 심사에서 **1~4차 전부 "가치가 별로 없는 콘텐츠"로 거절**됐고, 그 과정에서 확인된 수치가 [`../../Documents/project_process.md`](../../Documents/project_process.md)에 정리되어 있음. 위 §11.1의 "15~20편" 같은 일반론보다 이 실측이 우선함 — 병목은 편수가 아니라 **독자용 콘텐츠 절대량(4차 거절 5,385자 → 5차 준비 23,958자)** 과 **색인 코퍼스**였음. 상세 대응은 [`content-strategy.md §7·§10`](./content-strategy.md) 참조.
