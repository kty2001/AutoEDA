...
**Phase 1 완료. Phase 1.5 의 콘텐츠 게이트(15편·25,000자) 충족. 디자인 개편·해설 5편·회귀 복구까지 전부 배포 완료.**
...
| 테스트 | 239건 통과 (계약 21 + 동작 167 + 빌드 51) + 실기 11 + 배포본 9 |
...
- [ ] GSC 속성 등록 · **sitemap 재제출**(19 URL) · 신규 콘텐츠 URL 색인 요청 ([`content-strategy.md` §7](content-strategy.md) 게이트) — **Google 계정 필요, 직접 수행할 사항**
